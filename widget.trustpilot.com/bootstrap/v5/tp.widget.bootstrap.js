...
exports.PRODUCT_REVIEW_CAROUSEL_WIDGET_ID = exports.PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID = exports.PRODUCT_REVIEW_SEO_WIDGET_ID = exports.WIDGET_ROOT = exports.LAZY_LOADED_WIDGETS = exports.EMPTY_WIDGET_ID = undefined;
...
var PRODUCT_REVIEW_SEO_WIDGET_ID = '5717796816f630043868e2e8';
var PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID = '5763bccae0a06d08e809ecbb';
var PRODUCT_REVIEW_CAROUSEL_WIDGET_ID = '60f537b5b0f1639de1fe048c';

exports.EMPTY_WIDGET_ID = EMPTY_WIDGET_ID;
exports.LAZY_LOADED_WIDGETS = LAZY_LOADED_WIDGETS;
exports.WIDGET_ROOT = WIDGET_ROOT;
exports.PRODUCT_REVIEW_SEO_WIDGET_ID = PRODUCT_REVIEW_SEO_WIDGET_ID;
exports.PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID = PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID;
exports.PRODUCT_REVIEW_CAROUSEL_WIDGET_ID = PRODUCT_REVIEW_CAROUSEL_WIDGET_ID;
...
var _require = require('./constants.js'),
    ...
    PRODUCT_REVIEW_SEO_WIDGET_ID = _require.PRODUCT_REVIEW_SEO_WIDGET_ID,
    PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID = _require.PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID,
    PRODUCT_REVIEW_CAROUSEL_WIDGET_ID = _require.PRODUCT_REVIEW_CAROUSEL_WIDGET_ID;
...
function getProductSnippet(_ref2) {
  var businessunitId = _ref2.businessunitId,
      ...
      reviewLanguages = _ref2.reviewLanguages;

  var includeImported = templateId === PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID;
  ...
  var reviewLanguagesParam = reviewLanguages ? '&reviewLanguages=' + encodeURIComponent(reviewLanguages) : '';

  var url = '' + WIDGET_ROOT + path + '?sku=' + encodeURIComponent(sku) + '&numberOfReviews=' + (reviewnumber || 10) + (name ? '&productName=' + encodeURIComponent(name) : '') + reviewLanguagesParam + '&templateId=' + templateId + '&url=' + encodeURIComponent(window.location.origin + window.location.pathname);
...
var snippet = function snippet(dataset) {
  ...
  if (dataset.schemaType && dataset.location) {
    ...
    var isPRCarousel = dataset.templateId === PRODUCT_REVIEW_CAROUSEL_WIDGET_ID;
    var isProductSnippetSupportedWidget = dataset.templateId === PRODUCT_REVIEW_SEO_WIDGET_ID || dataset.templateId === PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID;
...
var IFrame = function () {
  ...
  _createClass(IFrame, [{
    ...
    value: function _shouldAllowRobots() {
      // For consistency all widgets need to pass allow list check
      if (widgetsThatCanAllowRobots.indexOf(this.templateId) === -1) {
        return false;
      }

      // Product Review SEO and Product Review Multi Source SEO widgets should always allow robots as they are specifically designed for SEO purposes
      if (this.templateId === _constants.PRODUCT_REVIEW_SEO_WIDGET_ID || this.templateId === _constants.PRODUCT_REVIEW_MULTI_SOURCE_SEO_WIDGET_ID) {
        return true;
      }

      // Service review widgets need to be showing location reviews and have allow-robots feature enabled
      return this.dataset.allowRobots === 'true' && this.dataset.location;
    }
  }, {
    key: 'dimensions',
    get: function get() {
